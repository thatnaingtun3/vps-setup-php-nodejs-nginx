...
echo "8.0, 8.1, 8.2, 8.3 ,8.4"
read -p "Enter the PHP version you want to install (e.g., 8.4): " php_version
...
sudo apt install -y \
    ...
    php$php_version-memcache php$php_version-pgsql \
    php$php_version-ldap php$php_version-swoole
